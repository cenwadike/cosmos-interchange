...
func (x *fastReflection_BuyOrderPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "interchange.dex.BuyOrderPacketData.price":
		return x.Price != int32(0)
	case "interchange.dex.BuyOrderPacketData.buyer":
		return x.Buyer != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_BuyOrderPacketData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "interchange.dex.BuyOrderPacketData.buyer":
		panic(fmt.Errorf("field buyer of message interchange.dex.BuyOrderPacketData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: interchange.dex.BuyOrderPacketData"))
		}
...
var file_interchange_dex_packet_proto_rawDesc = []byte{
	...
	0x04, 0x67, 0x61, 0x69, 0x6e, 0x22, 0x9a, 0x01, 0x0a, 0x12, 0x42, 0x75, 0x79, 0x4f, 0x72, 0x64,
	...
	0x65, 0x72, 0x22, 0x59, 0x0a, 0x11, 0x42, 0x75, 0x79, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x61,
	0x63, 0x6b, 0x65, 0x74, 0x41, 0x63, 0x6b, 0x12, 0x28, 0x0a, 0x0f, 0x72, 0x65, 0x6d, 0x61, 0x69,
	0x6e, 0x69, 0x6e, 0x67, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x0f, 0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x41, 0x6d, 0x6f, 0x75, 0x6e,
	0x74, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x08, 0x70, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x42, 0xa0, 0x01,
