...
func init() {
	file_interchange_dex_order_proto_init()
	md_OrderBook = File_interchange_dex_order_proto.Messages().ByName("OrderBook")
...
func (x *OrderBook) slowProtoReflect() protoreflect.Message {
	mi := &file_interchange_dex_order_proto_msgTypes[0]
...
func (x *fastReflection_OrderBook) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "interchange.dex.OrderBook.idCount":
		return x.IdCount != int32(0)
	case "interchange.dex.OrderBook.orders":
		return len(x.Orders) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: interchange.dex.OrderBook"))
		}
		panic(fmt.Errorf("message interchange.dex.OrderBook does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OrderBook) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message interchange.dex.OrderBook does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OrderBook) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "interchange.dex.OrderBook.idCount":
		panic(fmt.Errorf("field idCount of message interchange.dex.OrderBook is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: interchange.dex.OrderBook"))
		}
...
func (x *fastReflection_OrderBook) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in interchange.dex.OrderBook", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_interchange_dex_order_proto_init()
	md_Order = File_interchange_dex_order_proto.Messages().ByName("Order")
...
func (x *Order) slowProtoReflect() protoreflect.Message {
	mi := &file_interchange_dex_order_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Order) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "interchange.dex.Order.id":
		return x.Id != int32(0)
	case "interchange.dex.Order.creator":
		return x.Creator != ""
	case "interchange.dex.Order.amount":
		return x.Amount != int32(0)
	case "interchange.dex.Order.price":
		return x.Price != int32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: interchange.dex.Order"))
		}
		panic(fmt.Errorf("message interchange.dex.Order does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Order) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message interchange.dex.Order does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Order) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "interchange.dex.Order.id":
		panic(fmt.Errorf("field id of message interchange.dex.Order is not mutable"))
	case "interchange.dex.Order.creator":
		panic(fmt.Errorf("field creator of message interchange.dex.Order is not mutable"))
	case "interchange.dex.Order.amount":
		panic(fmt.Errorf("field amount of message interchange.dex.Order is not mutable"))
	case "interchange.dex.Order.price":
		panic(fmt.Errorf("field price of message interchange.dex.Order is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: interchange.dex.Order"))
		}
...
func (x *fastReflection_Order) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in interchange.dex.Order", d.FullName()))
	}
	panic("unreachable")
}
...
func (*OrderBook) Descriptor() ([]byte, []int) {
	return file_interchange_dex_order_proto_rawDescGZIP(), []int{0}
}
...
func (*Order) Descriptor() ([]byte, []int) {
	return file_interchange_dex_order_proto_rawDescGZIP(), []int{1}
}
...
var File_interchange_dex_order_proto protoreflect.FileDescriptor

var file_interchange_dex_order_proto_rawDesc = []byte{
	,
	...
	,
}

var (
	file_interchange_dex_order_proto_rawDescOnce sync.Once
	file_interchange_dex_order_proto_rawDescData = file_interchange_dex_order_proto_rawDesc
)

func file_interchange_dex_order_proto_rawDescGZIP() []byte {
	file_interchange_dex_order_proto_rawDescOnce.Do(func() {
		file_interchange_dex_order_proto_rawDescData = protoimpl.X.CompressGZIP(file_interchange_dex_order_proto_rawDescData)
	})
	return file_interchange_dex_order_proto_rawDescData
}

var file_interchange_dex_order_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_interchange_dex_order_proto_goTypes = []interface{}{
	(*OrderBook)(nil), // 0: interchange.dex.OrderBook
	(*Order)(nil),     // 1: interchange.dex.Order
}
var file_interchange_dex_order_proto_depIdxs = []int32{
	1, // 0: interchange.dex.OrderBook.orders:type_name -> interchange.dex.Order
...
func init() { file_interchange_dex_order_proto_init() }
func file_interchange_dex_order_proto_init() {
	if File_interchange_dex_order_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_interchange_dex_order_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_interchange_dex_order_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_interchange_dex_order_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_interchange_dex_order_proto_goTypes,
		DependencyIndexes: file_interchange_dex_order_proto_depIdxs,
		MessageInfos:      file_interchange_dex_order_proto_msgTypes,
	}.Build()
	File_interchange_dex_order_proto = out.File
	file_interchange_dex_order_proto_rawDesc = nil
	file_interchange_dex_order_proto_goTypes = nil
	file_interchange_dex_order_proto_depIdxs = nil
}
